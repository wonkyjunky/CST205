...
lib.ssMetadata = [
		{name:"728x90_atlas_P_", frames: [[0,304,150,150],[0,456,150,150],[0,608,150,150],[0,0,150,150],[0,152,150,150],[0,760,150,150],[152,0,150,150],[152,152,150,150],[152,304,150,150],[152,456,150,150],[152,608,150,150],[152,760,150,150],[304,0,150,150],[304,152,150,150],[304,304,150,150],[304,456,150,150],[304,608,105,30]]}
];
...
(lib._728x90 = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		function loadData() {
			...
			setTimeout(function(){ setData(content, cam); }, 500);
		}
		ad.root.stop();
		loadData();
	}
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/728x90_atlas_P_.png?1565329049890", id:"728x90_atlas_P_"}
	],
	preloads: []
};
